# %% [markdown]
# Grid Search Using Support Vector Machine (SVM)
...
# %% [markdown]
# Applying Grid Search Algorithm to find the best model and the best parameters
...
print("best accuracies:", best_accuracy.mean())
